...
#if (WINAPI_FAMILY == WINAPI_FAMILY_PC_APP || WINAPI_FAMILY == WINAPI_FAMILY_PHONE_APP)
	AllJoynWinRTComponent::AJ_AuthPwdFunc^ pwdCallback;  /**< Callback for obtaining passwords */
#else
 ...
 */
#if (WINAPI_FAMILY == WINAPI_FAMILY_PC_APP || WINAPI_FAMILY == WINAPI_FAMILY_PHONE_APP)
AJ_Status AJ_BusAuthenticatePeer(AJ_BusAttachment* bus, const char* peerBusName, AllJoynWinRTComponent::AJ_PeerAuthenticateCallback^ callback);
#else
